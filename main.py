...
class Game:
  ...
  def load_assets(self):
    ...
    self.img_player, self.img_arrow, self.img_icon = load_or_dummy('image_0.png', (40, 40), WHITE), load_or_dummy(
        'image_1.png', (35, 90), YELLOW), load_or_dummy('image_2.png', (50, 50), WHITE)
